...
experiment_name_file = "experiments/.current_experiment_name"
...
LOG_FILE = os.path.join("experiments", "snakemake_runs.log")
# Append the experiment directory to the log file
with open(LOG_FILE, "a") as log:
    log.write(f"Using experiment directory: {EXPERIMENT_DIR}\n")



rule all:
    # This rule specifies the final output files to be generated by the pipeline
    params:
        experiment_dir = EXPERIMENT_DIR,
    input: 
